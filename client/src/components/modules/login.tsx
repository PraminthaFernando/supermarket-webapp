...
const Login: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 bg-white bg-current bg-opacity-90 rounded-2xl">
      <div className="mx-auto max-w-lg">
        ...
        <p className="mx-auto mt-4 max-w-md text-center text-gray-500">
          If you have any problem, please contact us - 0710924987
        </p>
